 ...
 */
@WebServlet(name = "AnnouncementOverviewServlet", urlPatterns = {"/AnnouncementOverviewServlet"})
public class AnnouncementOverviewServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(AnnouncementOverviewServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
