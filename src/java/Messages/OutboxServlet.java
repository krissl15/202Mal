 ...
 * @author Elias
 */
@WebServlet(name = "OutboxServlet", urlPatterns = {"/OutboxServlet"})
...
"            </form>  \n");
            ...
            out.println("<div class=\"outboxDiv\">");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(OutboxServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
