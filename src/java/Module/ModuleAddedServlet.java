    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<body>\n"
                    ...
                    + "                <b>Status</b><br><input type=\"text\" name=\"textStatus\" placeholder=\"Aktiv/Inaktiv\" required> <br><br>  \n"
                    + "                <b>Fristdato</b><br><input type=\"text\" name=\"textDate\" placeholder=\"YYYYMMDD\" required> <br><br>  \n"
                    + "\n"
                    + "\n"
